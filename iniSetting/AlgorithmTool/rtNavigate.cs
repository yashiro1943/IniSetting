...
namespace AlgorithmTool
{
    ...
    public class rtPathPlanning
    {
        ...
        public static void rtAGV_FindPathNode2Dest(int a_lSrc, int a_lDst, rtNode[] a_atNode, int[] a_alMapCurrent, int a_lNodeNum, ref int a_lPathLength, ref rtPath_Info[] a_atPathInfo)
        {
            ...
            {
                a_atPathInfo[lCnt].tSrc.eX = a_atNode[alPathResult[lCnt]].tCoordinate.eX;
                a_atPathInfo[lCnt].tSrc.eY = a_atNode[alPathResult[lCnt]].tCoordinate.eY;

                a_atPathInfo[lCnt].tDest.eX = a_atNode[alPathResult[lCnt+1]].tCoordinate.eX;
                a_atPathInfo[lCnt].tDest.eY = a_atNode[alPathResult[lCnt+1]].tCoordinate.eY;
            }
        }
