...
namespace AlgorithmTool
{
    ...
    /// <summary> the struct of Block detail information </summary>
    public struct rtBlockInfo
    {
    ...
    /// <summary> Node struct of MAP </summary>
    public struct rtNode
    {
        /// <summary> node position </summary>
        public rtVector tCoordinate;

        /// <summary> List of region link: length > 0 表示此點可以通往其它 region </summary>
        public List<int> LlLinkofRegion;

        /// <summary> List of node link: length > 0 表示此點可以通往其它 node </summary>
        public List<int> LlLinkofNode;
    }

    /// <summary> the struct of Warehouse detail information </summary>
    public struct rtWarehouseInfo
    {
    ...
    /// <summary> Struct of Intelligent-Storage-System MAP's Region </summary>
    public struct RegionOfMap
    {
        /// <summary> Region position </summary>
        public rtVector tCoordinate;

        /// <summary> node number: 節點個數 </summary>
        public int lNodeNum;

        /// <summary> node number: 貨架個數 </summary>
        public int lWarehouseNum;

        /// <summary> node number: 障礙區個數 </summary>
        public int lBlockNum;

        /// <summary> Goods Infomation of each one >> 貨架設定</summary>
        public rtWarehouseInfo[] atWarehouseCfg;

        /// <summary> block Infomation of each one >> 障礙區設定</summary>
        public rtBlockInfo[] atBlockCfg;

        /// <summary> node in local 節點 </summary>
        public rtNode[] atNode;
    
        /// <summary> Map table of Node : 每區節點的路徑權重表 算最短路徑用</summary>
        public int[] alPathTableNode;
    }

    /// <summary> Struct of Intelligent-Storage-System MAP </summary>
    public struct rtAGV_MAP
    {
        /// <summary> Region number: 區域個數 </summary>
        public int alRegionNum;

        /// <summary> 區域設定 </summary>
        public RegionOfMap[] atRegionCfg;

        /// <summary> Map table in global : 區域間的路徑權重表 算最短路徑用</summary>
        public int[] alPathTableRegion;

        /// <summary> Initial function </summary>
        public void Init()
        {
            alRegionNum = 0;
            atRegionCfg = new RegionOfMap[alRegionNum];
            alPathTableRegion = new int[alRegionNum];
        }
    }
